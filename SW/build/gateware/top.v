//--------------------------------------------------------------------------------
// Auto-generated by Migen (41922fd) & LiteX (b6d35c92) on 2020-02-14 03:01:06
//--------------------------------------------------------------------------------
module top(
...
wire csrbankarray_csrbank0_init0_we;
wire [7:0] csrbankarray_csrbank0_init0_w;
wire csrbankarray_csrbank0_done_re;
wire [7:0] csrbankarray_csrbank0_done_r;
wire csrbankarray_csrbank0_done_we;
wire [7:0] csrbankarray_csrbank0_done_w;
wire csrbankarray_csrbank0_result_re;
wire [7:0] csrbankarray_csrbank0_result_r;
wire csrbankarray_csrbank0_result_we;
wire [7:0] csrbankarray_csrbank0_result_w;
...
wire csrbankarray_csrbank1_bus_errors_we;
...
wire csrbankarray_csrbank4_tuning_word0_we;
...
assign interface0_soc_bus_adr = lm32_ibus_adr;
assign interface0_soc_bus_dat_w = lm32_ibus_dat_w;
assign lm32_ibus_dat_r = interface0_soc_bus_dat_r;
assign interface0_soc_bus_sel = lm32_ibus_sel;
assign interface0_soc_bus_cyc = lm32_ibus_cyc;
assign interface0_soc_bus_stb = lm32_ibus_stb;
assign lm32_ibus_ack = interface0_soc_bus_ack;
assign interface0_soc_bus_we = lm32_ibus_we;
assign interface0_soc_bus_cti = lm32_ibus_cti;
assign interface0_soc_bus_bte = lm32_ibus_bte;
assign lm32_ibus_err = interface0_soc_bus_err;
assign interface1_soc_bus_adr = lm32_dbus_adr;
assign interface1_soc_bus_dat_w = lm32_dbus_dat_w;
assign lm32_dbus_dat_r = interface1_soc_bus_dat_r;
assign interface1_soc_bus_sel = lm32_dbus_sel;
assign interface1_soc_bus_cyc = lm32_dbus_cyc;
assign interface1_soc_bus_stb = lm32_dbus_stb;
assign lm32_dbus_ack = interface1_soc_bus_ack;
assign interface1_soc_bus_we = lm32_dbus_we;
assign interface1_soc_bus_cti = lm32_dbus_cti;
assign interface1_soc_bus_bte = lm32_dbus_bte;
assign lm32_dbus_err = interface1_soc_bus_err;
...
assign csrbankarray_csrbank0_sel = (csrbankarray_interface0_bank_bus_adr[13:9] == 2'd3);
...
assign csrbankarray_csrbank0_init0_we = ((csrbankarray_csrbank0_sel & (~csrbankarray_interface0_bank_bus_we)) & (csrbankarray_interface0_bank_bus_adr[1:0] == 1'd0));
...
assign csrbankarray_csrbank0_done_we = ((csrbankarray_csrbank0_sel & (~csrbankarray_interface0_bank_bus_we)) & (csrbankarray_interface0_bank_bus_adr[1:0] == 1'd1));
assign csrbankarray_csrbank0_result_r = csrbankarray_interface0_bank_bus_dat_w[7:0];
assign csrbankarray_csrbank0_result_re = ((csrbankarray_csrbank0_sel & csrbankarray_interface0_bank_bus_we) & (csrbankarray_interface0_bank_bus_adr[1:0] == 2'd2));
assign csrbankarray_csrbank0_result_we = ((csrbankarray_csrbank0_sel & (~csrbankarray_interface0_bank_bus_we)) & (csrbankarray_interface0_bank_bus_adr[1:0] == 2'd2));
assign csrbankarray_csrbank0_init0_w = storage[7:0];
assign csrbankarray_csrbank0_done_w = done_status[7:0];
assign done_we = csrbankarray_csrbank0_done_we;
assign csrbankarray_csrbank0_result_w = result_status[7:0];
assign result_we = csrbankarray_csrbank0_result_we;
...
assign ctrl_reset_reset_we = ((csrbankarray_csrbank1_sel & (~csrbankarray_interface1_bank_bus_we)) & (csrbankarray_interface1_bank_bus_adr[1:0] == 1'd0));
...
assign csrbankarray_csrbank1_scratch0_we = ((csrbankarray_csrbank1_sel & (~csrbankarray_interface1_bank_bus_we)) & (csrbankarray_interface1_bank_bus_adr[1:0] == 1'd1));
...
assign csrbankarray_csrbank1_bus_errors_we = ((csrbankarray_csrbank1_sel & (~csrbankarray_interface1_bank_bus_we)) & (csrbankarray_interface1_bank_bus_adr[1:0] == 2'd2));
assign csrbankarray_csrbank1_scratch0_w = ctrl_storage[31:0];
assign csrbankarray_csrbank1_bus_errors_w = ctrl_bus_errors_status[31:0];
assign ctrl_bus_errors_we = csrbankarray_csrbank1_bus_errors_we;
...
assign csrbankarray_csrbank2_load0_we = ((csrbankarray_csrbank2_sel & (~csrbankarray_interface2_bank_bus_we)) & (csrbankarray_interface2_bank_bus_adr[2:0] == 1'd0));
...
assign csrbankarray_csrbank2_reload0_we = ((csrbankarray_csrbank2_sel & (~csrbankarray_interface2_bank_bus_we)) & (csrbankarray_interface2_bank_bus_adr[2:0] == 1'd1));
...
assign csrbankarray_csrbank2_en0_we = ((csrbankarray_csrbank2_sel & (~csrbankarray_interface2_bank_bus_we)) & (csrbankarray_interface2_bank_bus_adr[2:0] == 2'd2));
assign csrbankarray_csrbank2_update_value0_r = csrbankarray_interface2_bank_bus_dat_w[0];
assign csrbankarray_csrbank2_update_value0_re = ((csrbankarray_csrbank2_sel & csrbankarray_interface2_bank_bus_we) & (csrbankarray_interface2_bank_bus_adr[2:0] == 2'd3));
assign csrbankarray_csrbank2_update_value0_we = ((csrbankarray_csrbank2_sel & (~csrbankarray_interface2_bank_bus_we)) & (csrbankarray_interface2_bank_bus_adr[2:0] == 2'd3));
...
assign csrbankarray_csrbank2_value_we = ((csrbankarray_csrbank2_sel & (~csrbankarray_interface2_bank_bus_we)) & (csrbankarray_interface2_bank_bus_adr[2:0] == 3'd4));
...
assign timer0_eventmanager_status_we = ((csrbankarray_csrbank2_sel & (~csrbankarray_interface2_bank_bus_we)) & (csrbankarray_interface2_bank_bus_adr[2:0] == 3'd5));
...
assign timer0_eventmanager_pending_we = ((csrbankarray_csrbank2_sel & (~csrbankarray_interface2_bank_bus_we)) & (csrbankarray_interface2_bank_bus_adr[2:0] == 3'd6));
...
assign csrbankarray_csrbank2_ev_enable0_we = ((csrbankarray_csrbank2_sel & (~csrbankarray_interface2_bank_bus_we)) & (csrbankarray_interface2_bank_bus_adr[2:0] == 3'd7));
assign csrbankarray_csrbank2_load0_w = timer0_load_storage[31:0];
assign csrbankarray_csrbank2_reload0_w = timer0_reload_storage[31:0];
assign csrbankarray_csrbank2_en0_w = timer0_en_storage;
assign csrbankarray_csrbank2_update_value0_w = timer0_update_value_storage;
assign csrbankarray_csrbank2_value_w = timer0_value_status[31:0];
assign timer0_value_we = csrbankarray_csrbank2_value_we;
assign csrbankarray_csrbank2_ev_enable0_w = timer0_eventmanager_storage;
assign csrbankarray_csrbank3_sel = (csrbankarray_interface3_bank_bus_adr[13:9] == 3'd4);
...
assign uart_rxtx_we = ((csrbankarray_csrbank3_sel & (~csrbankarray_interface3_bank_bus_we)) & (csrbankarray_interface3_bank_bus_adr[2:0] == 1'd0));
...
assign csrbankarray_csrbank3_txfull_we = ((csrbankarray_csrbank3_sel & (~csrbankarray_interface3_bank_bus_we)) & (csrbankarray_interface3_bank_bus_adr[2:0] == 1'd1));
...
assign csrbankarray_csrbank3_rxempty_we = ((csrbankarray_csrbank3_sel & (~csrbankarray_interface3_bank_bus_we)) & (csrbankarray_interface3_bank_bus_adr[2:0] == 2'd2));
...
assign uart_eventmanager_status_we = ((csrbankarray_csrbank3_sel & (~csrbankarray_interface3_bank_bus_we)) & (csrbankarray_interface3_bank_bus_adr[2:0] == 2'd3));
...
assign uart_eventmanager_pending_we = ((csrbankarray_csrbank3_sel & (~csrbankarray_interface3_bank_bus_we)) & (csrbankarray_interface3_bank_bus_adr[2:0] == 3'd4));
...
assign csrbankarray_csrbank3_ev_enable0_we = ((csrbankarray_csrbank3_sel & (~csrbankarray_interface3_bank_bus_we)) & (csrbankarray_interface3_bank_bus_adr[2:0] == 3'd5));
assign csrbankarray_csrbank3_txfull_w = uart_txfull_status;
assign uart_txfull_we = csrbankarray_csrbank3_txfull_we;
assign csrbankarray_csrbank3_rxempty_w = uart_rxempty_status;
assign uart_rxempty_we = csrbankarray_csrbank3_rxempty_we;
assign csrbankarray_csrbank3_ev_enable0_w = uart_eventmanager_storage[1:0];
...
assign csrbankarray_csrbank4_tuning_word0_we = ((csrbankarray_csrbank4_sel & (~csrbankarray_interface4_bank_bus_we)) & (csrbankarray_interface4_bank_bus_adr[0] == 1'd0));
assign csrbankarray_csrbank4_tuning_word0_w = uart_phy_storage[31:0];
...
always @(posedge sys_clk) begin
	...
	if (csrbankarray_csrbank0_sel) begin
		case (csrbankarray_interface0_bank_bus_adr[1:0])
			...
			2'd2: begin
				csrbankarray_interface0_bank_bus_dat_r <= csrbankarray_csrbank0_result_w;
			end
		endcase
	end
	if (csrbankarray_csrbank0_init0_re) begin
		storage[7:0] <= csrbankarray_csrbank0_init0_r;
	end
	...
	if (csrbankarray_csrbank1_scratch0_re) begin
		ctrl_storage[31:0] <= csrbankarray_csrbank1_scratch0_r;
	end
	...
	if (csrbankarray_csrbank2_sel) begin
		case (csrbankarray_interface2_bank_bus_adr[2:0])
			...
			2'd3: begin
				csrbankarray_interface2_bank_bus_dat_r <= csrbankarray_csrbank2_update_value0_w;
			end
			3'd4: begin
	...
	if (csrbankarray_csrbank2_load0_re) begin
		timer0_load_storage[31:0] <= csrbankarray_csrbank2_load0_r;
	end
	timer0_load_re <= csrbankarray_csrbank2_load0_re;
	if (csrbankarray_csrbank2_reload0_re) begin
		timer0_reload_storage[31:0] <= csrbankarray_csrbank2_reload0_r;
	end
	timer0_reload_re <= csrbankarray_csrbank2_reload0_re;
	if (csrbankarray_csrbank2_en0_re) begin
		timer0_en_storage <= csrbankarray_csrbank2_en0_r;
	end
	timer0_en_re <= csrbankarray_csrbank2_en0_re;
	if (csrbankarray_csrbank2_update_value0_re) begin
		timer0_update_value_storage <= csrbankarray_csrbank2_update_value0_r;
	end
	timer0_update_value_re <= csrbankarray_csrbank2_update_value0_re;
	if (csrbankarray_csrbank2_ev_enable0_re) begin
		timer0_eventmanager_storage <= csrbankarray_csrbank2_ev_enable0_r;
	end
	...
	if (csrbankarray_csrbank3_ev_enable0_re) begin
		uart_eventmanager_storage[1:0] <= csrbankarray_csrbank3_ev_enable0_r;
	end
	...
	if (csrbankarray_csrbank4_tuning_word0_re) begin
		uart_phy_storage[31:0] <= csrbankarray_csrbank4_tuning_word0_r;
	end
...
test_cam test_cam(
	.CAM_href(cam_master_CAM_href),
	.CAM_pclk(cam_master_CAM_pclk),
	.CAM_px_data_0(cam_master_Cam_px_data_0),
	.CAM_px_data_1(cam_master_Cam_px_data_1),
	.CAM_px_data_2(cam_master_Cam_px_data_2),
	.CAM_px_data_3(cam_master_Cam_px_data_3),
	.CAM_px_data_4(cam_master_Cam_px_data_4),
	.CAM_px_data_5(cam_master_Cam_px_data_5),
	.CAM_px_data_6(cam_master_Cam_px_data_6),
	.CAM_px_data_7(cam_master_Cam_px_data_7),
	.CAM_vsync(cam_master_CAM_vsync),
	.clk(sys_clk),
	.init(storage),
	.rst(rst),
	.CAM_pwdn(cam_master_CAM_pwdn),
	.CAM_reset(cam_master_CAM_reset),
	.CAM_xclk(cam_master_CAM_xclk),
	.done(done_status),
